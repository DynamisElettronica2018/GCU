...
;DY_GCU.c,55 :: 		dSignalLed_init();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	CALL	_dSignalLed_init
;DY_GCU.c,56 :: 		Can_init();
	CALL	_Can_init
...
;DY_GCU.c,136 :: 		}
L_timer1_interrupt8:
;DY_GCU.c,137 :: 		if (timer1_counter4 >= 100)
	MOV	#100, W1
	MOV	#lo_addr(_timer1_counter4), W0
	CP	W1, [W0]
...
;DY_GCU.c,139 :: 		Can_resetWritePacket();
	CALL	_Can_resetWritePacket
;DY_GCU.c,140 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,141 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
...
;DY_GCU.c,143 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,144 :: 		Can_write(GCU_DEBUG_1_ID);
	MOV	#790, W10
	MOV	#0, W11
	CALL	_Can_write
;DY_GCU.c,145 :: 		Can_resetWritePacket();
	CALL	_Can_resetWritePacket
;DY_GCU.c,146 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,147 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
...
;DY_GCU.c,149 :: 		Can_addIntToWritePacket(20);
	MOV	#20, W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,150 :: 		Can_write(GCU_DEBUG_2_ID);
	MOV	#791, W10
	MOV	#0, W11
	CALL	_Can_write
;DY_GCU.c,151 :: 		timer1_counter4 = 0;
	CLR	W0
...
;DY_GCU.c,164 :: 		onCanInterrupt{
;DY_GCU.c,169 :: 		Can_read(&id, dataBuffer, &dataLen, &flags);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	MOV	W0, W10
	CALL	_Can_read
;DY_GCU.c,170 :: 		Can_clearInterrupt();
	CALL	_Can_clearInterrupt
;DY_GCU.c,172 :: 		if (dataLen >= 2) {
	MOV	[W14+14], W0
	CP	W0, #2
	BRA GEU	L__CAN_Interrupt44
	GOTO	L_CAN_Interrupt10
L__CAN_Interrupt44:
;DY_GCU.c,173 :: 		firstInt = (unsigned int) ((dataBuffer[0] << 8) | (dataBuffer[1] & 0xFF));
	ADD	W14, #6, W1
	MOV.B	[W1], W0
	ZE	W0, W0
	SL	W0, #8, W2
...
;DY_GCU.c,183 :: 		}
L_CAN_Interrupt13:
;DY_GCU.c,186 :: 		switch (id) {
	GOTO	L_CAN_Interrupt14
;DY_GCU.c,187 :: 		case EFI_GEAR_RPM_TPS_APPS_ID:
L_CAN_Interrupt16:
;DY_GCU.c,188 :: 		GearShift_setCurrentGear(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_setCurrentGear
;DY_GCU.c,189 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,191 :: 		case SW_FIRE_GCU_ID:
L_CAN_Interrupt17:
;DY_GCU.c,192 :: 		EngineControl_resetStartCheck();           //resetCheckCounter = 0
	CALL	_EngineControl_resetStartCheck
;DY_GCU.c,193 :: 		EngineControl_start();                     //debug on LED D2 board
	CALL	_EngineControl_start
;DY_GCU.c,194 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,210 :: 		case SW_GEARSHIFT_ID:
L_CAN_Interrupt18:
;DY_GCU.c,211 :: 		GearShift_injectCommand(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_injectCommand
;DY_GCU.c,212 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,224 :: 		case SW_CLUTCH_TARGET_GCU_ID:
L_CAN_Interrupt19:
;DY_GCU.c,229 :: 		if ((!gearShift_isShiftingDown && !gearShift_isSettingNeutral) || gearShift_isUnsettingNeutral) {
...
L__CAN_Interrupt27:
L__CAN_Interrupt31:
;DY_GCU.c,231 :: 		Clutch_setBiased(dataBuffer[0]);
	ADD	W14, #6, W0
	MOV.B	[W0], W10
...
;DY_GCU.c,237 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,264 :: 		case EFI_HALL_ID:
L_CAN_Interrupt25:
;DY_GCU.c,266 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,289 :: 		default:
L_CAN_Interrupt26:
;DY_GCU.c,290 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,291 :: 		}
